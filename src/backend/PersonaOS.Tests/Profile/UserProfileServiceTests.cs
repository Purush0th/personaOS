...
public class UserProfileServiceTests
{
    ...
    public async Task Saves_the_text_trimmed_and_reads_it_back()
    {
        ...
        await new UserProfileService(db).UpdateAsync("  Vegetarian. Lives in Chennai.  ");

        Assert.Equal("Vegetarian. Lives in Chennai.", (await new UserProfileService(db).GetAsync()).AboutMe);
    }
